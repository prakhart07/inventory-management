    ...
    return (
        ...
        <div style={{ minHeight: '100vh', background: '#f5f7fa' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px', marginBottom: '32px' }}>
                    <div style={{ background: 'white', borderRadius: '16px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div style={{ width: '60px', height: '60px', borderRadius: '14px', background: 'linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '28px' }}>📊</div>
                            <div>
                                <div style={{ fontSize: '11px', fontWeight: '600', color: '#94a3b8', letterSpacing: '0.8px', marginBottom: '8px' }}>TOTAL EXPENSES</div>
                                <div style={{ fontSize: '36px', fontWeight: 'bold', color: '#1e293b' }}>₹{stats.total.toLocaleString()}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ background: 'white', borderRadius: '16px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div style={{ width: '60px', height: '60px', borderRadius: '14px', background: 'linear-gradient(135deg, #f59e0b 0%, #d97706 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '28px' }}>⏰</div>
                            <div>
                                <div style={{ fontSize: '11px', fontWeight: '600', color: '#94a3b8', letterSpacing: '0.8px', marginBottom: '8px' }}>PENDING APPROVAL</div>
                                <div style={{ fontSize: '36px', fontWeight: 'bold', color: '#1e293b' }}>₹{stats.pending.toLocaleString()}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ background: 'white', borderRadius: '16px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            ...
                            <div>
                                <div style={{ fontSize: '11px', fontWeight: '600', color: '#94a3b8', letterSpacing: '0.8px', marginBottom: '8px' }}>APPROVED THIS MONTH</div>
                                <div style={{ fontSize: '36px', fontWeight: 'bold', color: '#1e293b' }}>₹{stats.approved.toLocaleString()}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style={{ background: 'white', borderRadius: '16px', padding: '28px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div style={{ width: '60px', height: '60px', borderRadius: '14px', background: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '28px' }}>📅</div>
                            <div>
                                <div style={{ fontSize: '11px', fontWeight: '600', color: '#94a3b8', letterSpacing: '0.8px', marginBottom: '8px' }}>RECURRING MONTHLY</div>
                                <div style={{ fontSize: '36px', fontWeight: 'bold', color: '#1e293b' }}>₹{stats.recurring.toLocaleString()}</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        {categories.map((category) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span style={{ fontSize: '15px', fontWeight: '700', color: category.color }}>{category.name}</span>
                                    <span style={{ fontSize: '12px', color: '#64748b' }}>₹{categoryTotal.toLocaleString()}</span>
                                </button>
                            );
                        })}
                    </div>
                ...
                {/* Action Bar */}
                <div style={{ background: 'white', borderRadius: '16px', padding: '20px', marginBottom: '24px', display: 'flex', gap: '12px', alignItems: 'center', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                    <div style={{ flex: 1, position: 'relative' }}>
                        ...
                        <input
                            ...
                            style={{ width: '100%', padding: '14px 14px 14px 48px', border: '1px solid #e2e8f0', borderRadius: '10px', fontSize: '14px', outline: 'none', background: 'white' }}
                        />
                    </div>
                    ...
                    <button onClick={() => setShowModal(true)} style={{ padding: '14px 24px', background: '#475569', border: 'none', borderRadius: '10px', fontWeight: '600', fontSize: '14px', color: 'white', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}>
                        <Plus size={18} />
                        Add Expense
                    </button>
                </div>
                ...
                {/* Tabs */}
                <div style={{ background: 'white', borderRadius: '14px', padding: '6px', marginBottom: '24px', display: 'flex', gap: '6px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
                ...
                {/* Table */}
                <div style={{ background: 'white', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', marginBottom: '32px' }}>
                    <div style={{ overflowX: 'auto' }}>
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            <thead>
                                <tr style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                                    <th style={{ padding: '18px', textAlign: 'left', fontSize: '11px', fontWeight: '700', color: '#64748b', letterSpacing: '0.8px' }}>DESCRIPTION</th>
                                    <th style={{ padding: '18px', textAlign: 'left', fontSize: '11px', fontWeight: '700', color: '#64748b', letterSpacing: '0.8px' }}>CATEGORY</th>
                                    <th style={{ padding: '18px', textAlign: 'left', fontSize: '11px', fontWeight: '700', color: '#64748b', letterSpacing: '0.8px' }}>PROJECT</th>
                                    <th style={{ padding: '18px', textAlign: 'left', fontSize: '11px', fontWeight: '700', color: '#64748b', letterSpacing: '0.8px' }}>AMOUNT</th>
                                    <th style={{ padding: '18px', textAlign: 'left', fontSize: '11px', fontWeight: '700', color: '#64748b', letterSpacing: '0.8px' }}>DATE</th>
                                    <th style={{ padding: '18px', textAlign: 'left', fontSize: '11px', fontWeight: '700', color: '#64748b', letterSpacing: '0.8px' }}>TYPE</th>
                                    <th style={{ padding: '18px', textAlign: 'left', fontSize: '11px', fontWeight: '700', color: '#64748b', letterSpacing: '0.8px' }}>STATUS</th>
                                    <th style={{ padding: '18px', textAlign: 'left', fontSize: '11px', fontWeight: '700', color: '#64748b', letterSpacing: '0.8px' }}>ACTIONS</th>
                                </tr>
                            </thead>
                            <tbody>
                                {filteredExpenses.map((expense) => {
                                    ...
                                    return (
                                        <tr key={expense.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                                            ...
                                            <td style={{ padding: '18px', color: '#475569', fontSize: '14px' }}>{expense.project}</td>
                                            <td style={{ padding: '18px', fontWeight: '700', color: '#1e293b', fontSize: '15px' }}>₹{expense.amount.toLocaleString()}</td>
                                            <td style={{ padding: '18px', color: '#64748b', fontSize: '14px' }}>{new Date(expense.date).toLocaleDateString('en-IN')}</td>
                                            <td style={{ padding: '18px' }}>
                                                <span style={{
                                                    padding: '5px 12px',
                                                    borderRadius: '6px',
                                                    fontSize: '12px',
                                                    fontWeight: '600',
                                                    background: expense.type === 'recurring' ? '#dbeafe' : '#fef3c7',
                                                    color: expense.type === 'recurring' ? '#3b82f6' : '#d97706'
                                                }}>
                                                    {expense.type}
                                                </span>
                                            </td>
                                            ...
                                            <td style={{ padding: '18px' }}>
                                                <a href="#" style={{ color: '#8b5cf6', fontWeight: '600', fontSize: '14px', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '4px' }}>
                                                    <Eye size={16} />
                                                    View
                                                </a>
                                            </td>
            ...
            {showModal && (
                <div onClick={() => setShowModal(false)} style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '20px' }}>
                    <div onClick={(e) => e.stopPropagation()} style={{ background: 'white', borderRadius: '16px', maxWidth: '600px', width: '100%', maxHeight: '90vh', overflowY: 'auto' }}>
                        <div style={{ background: '#475569', padding: '24px', borderRadius: '16px 16px 0 0' }}>
                        ...
                        <div style={{ padding: '24px' }}>
                            ...
                            <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
                                ...
                                <button
                                    ...
                                    style={{ padding: '12px 24px', background: '#475569', border: 'none', borderRadius: '10px', fontWeight: '600', fontSize: '14px', color: 'white', cursor: 'pointer' }}
                                >
                                    Add Expense
                                </button>
                            </div>
